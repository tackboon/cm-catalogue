...
// MobileAPIInfo defines model for MobileAPIInfo.
type MobileAPIInfo struct {
...
// SchemaFile defines model for SchemaFile.
...
// GetMobileAPIInfo operation middleware
func (siw *ServerInterfaceWrapper) GetMobileAPIInfo(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	ctx = context.WithValue(ctx, BearerAuthScopes, []string{""})

	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetMobileAPIInfo(w, r)
	}
